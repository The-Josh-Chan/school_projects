/********************************************************************
  ...
  Modified by B. Surgenor, 23/07/2019 - changed format
  MOdified by B. Surgenor, 17/01/2021 - runs continously until button press
...
void loop() {
  ...
  Serial.println(mv);
     ...
     delay(500); //wait 0.5 sec before reading again
     }while(digitalRead(BUTTON)== LOW);
